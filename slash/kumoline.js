...
const { KumoLine } = require("../games/kumoline");
...
module.exports = {
  ...
  */
  data: new SlashCommandBuilder()
    .setName("kumoline")
    .setDescription(
      "Play a game of Kumo Line! 2 players recommended. Estimated Play-time: 1-2 minutes."
    )
          ...
          collector.on("collect", async (reaction, user) => {
            ...
            if (
              ...
              noEmbed.setDescription(
                interaction.options.getUser("opponent").username +
                  " didn't feel like playing Kumo Line... ((´д｀))"
              );
