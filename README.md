...
- **/kumoduel `opponent` `basehp`**: Challenge a user to Kumo Duel! Work in progress, intended to be a turn based fighting game, with player inventories and log files...Next command, I aim to finish it very soon.
